...
namespace TrainingHitakshi\AffectedProducts\Block\Adminhtml;
...
class AffectedProductslist extends \Magento\Backend\Block\Template
{
     ...
     * @param \TrainingHitakshi\AffectedProducts\Model\Rule $rule
     * @param array                                                             $data
     */
    ...
    public function getBlockGrid()
    {
        if (null === $this->blockGrid) {
            $this->blockGrid = $this->getLayout()->createBlock(
                'TrainingHitakshi\AffectedProducts\Block\Adminhtml\Tab\Productgrid',
