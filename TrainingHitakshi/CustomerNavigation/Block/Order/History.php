<?php
namespace TrainingHitakshi\CustomerNavigation\Block\Order;
...
class History extends \Magento\Framework\View\Element\Template
{
    ...
    {
        parent::_construct();
        $this->pageConfig->getTitle()->set(__('My Completed Orders'));
    }
    ...
    public function getAllOrder()
    {
        ...
        if ($cutId) {
            ...
            $orderColl->addAttributeToFilter('status','complete');
        }
        return $orderColl;
    }
